    ...
    return (
        <div className='category-container'>
            ...
            <div className="categories">
                <CategorySlice name="All" r="12" g="36" b="97" imgUrl="../Images/category/productivity.png" />
                <CategorySlice name="Education" r="183" g="21" b="64" imgUrl="../Images/category/study.png" />
                <CategorySlice name="Entertainment" r="7" g="153" b="146" imgUrl="../Images/category/social-media.png" />
